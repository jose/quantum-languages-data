...
pre_process_data <- function(df) {
  ...
  names(df)[names(df) == 'How.many.years.have.you.coded.𝐩𝐫𝐨𝐟𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥𝐥𝐲..as.a.part.of.your.work..'] <- 'years_coded_professionally'
  ...
  names(df)[names(df) == 'Where.and.how.did.you.learn.𝐐𝐮𝐚𝐧𝐭𝐮𝐦.𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐢𝐧𝐠.𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞𝐬.'] <- 'learned_qpl'
  names(df)[names(df) == 'How.many.years.have.you.been.coding.using.𝐐𝐮𝐚𝐧𝐭𝐮𝐦.𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐢𝐧𝐠.𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞𝐬.'] <- 'years_coded_qpls'
  names(df)[names(df) == 'How.many.years.have.you.coded.𝐩𝐫𝐨𝐟𝐞𝐬𝐬𝐢𝐨𝐧𝐚𝐥𝐥𝐲.using.𝐐𝐮𝐚𝐧𝐭𝐮𝐦.𝐏𝐫𝐨𝐠𝐫𝐚𝐦𝐦𝐢𝐧𝐠.𝐋𝐚𝐧𝐠𝐮𝐚𝐠𝐞𝐬..as.a.part.of.your.work..'] <- 'years_coded_professionally_qpls'
  ...
  names(df)[names(df) == 'What.Quantum.Programming.Languages...frameworks.have.you.been.using.and.for.how.long...𝐿𝐼𝑄𝑈𝑖...'] <- 'used_qpls_liqui'
  ...
  names(df)[names(df) == 'What.Quantum.Programming.Languages...frameworks.have.you.been.using.and.for.how.long...𝑄.𝑆𝐼..'] <- 'used_qpls_qsi'
  ...
  names(df)[names(df) == 'What.Quantum.Programming.Languages...frameworks.have.you.been.using.and.for.how.long...𝜆𝑞..Lambda.Calculi..'] <- 'used_qpls_lambda_calculi'
  ...
  names(df)[names(df) == 'Which.of.the.following.is.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language...framework.'] <- 'primary_qpl'
  names(df)[names(df) == 'In.terms.of.ease...rate.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language...Features...functionalities.of.the.language.'] <- 'rate_primary_qpl_features'
  names(df)[names(df) == 'In.terms.of.ease...rate.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language...Documentation.avaliable.'] <- 'rate_primary_qpl_documentation'
  names(df)[names(df) == 'In.terms.of.ease...rate.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language...Code.examples.'] <- 'rate_primary_qpl_code_examples'
  names(df)[names(df) == 'In.terms.of.ease...rate.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language...Several.forums.'] <- 'rate_primary_qpl_forums'
  names(df)[names(df) == 'In.terms.of.ease...rate.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language...Support..e.g...github.issues..'] <- 'rate_primary_qpl_support'
  names(df)[names(df) == 'In.terms.of.ease...rate.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language...Easy.to.code.'] <- 'rate_primary_qpl_easy_to_code'
  names(df)[names(df) == 'Is.there.anything.else.you.𝗹𝗶𝗸𝗲.𝘁𝗵𝗲.𝗺𝗼𝘀𝘁.in.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language.'] <- 'like_primary_qpl'
  names(df)[names(df) == 'Is.there.anything.else.you.𝗱𝗼.𝗻𝗼𝘁.𝗹𝗶𝗸𝗲.in.your.𝐩𝐫𝐢𝐦𝐚𝐫𝐲.Quantum.Programming.Language.'] <- 'not_like_primary_qpl'
